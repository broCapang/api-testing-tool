...
@app.post("/security_test_cases/", response_model=schemas.SecurityTestCase)
def create_security_test_case(security_test_case: schemas.SecurityTestCaseCreate, db: Session = Depends(get_db)):
